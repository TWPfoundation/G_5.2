...
## Appendix B — Suggested next canon file

The next best file after these five is `continuity-facts.yaml`, because it gives the system a factual spine instead of forcing it to recover stable truths from reflections and chat history.

## Appendix C — What to review first

When you read these drafts, the most useful questions are:
- is the **constitution** too clinical, or finally sane?
- do the **axioms** feel genuinely foundational or still too ornamental?
- does **epistemics** draw the line sharply enough between inference and myth?
- are the **constraints** strong enough to stop drift without killing the project’s character?
- does the **voice** sound like the system you want, or like the system after therapy?
